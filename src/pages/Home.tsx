...
export default function Home() {
  ...
  const regularAccounts = accounts?.filter(a => !a.isSystemDefault && a.id !== 'acc_system_ef' && !a.id.startsWith('acc_ef_')) || [];
  const emergencyFund = accounts?.find(a => a.isSystemDefault || a.id === 'acc_system_ef' || a.id.startsWith('acc_ef_'));
